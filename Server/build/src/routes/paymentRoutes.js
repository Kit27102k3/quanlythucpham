...
router.post("/update-status/:orderId", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var orderId, status, Order, order;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("../Model/Order.js"));
        ...
        case 21:
          ...
          console.error("Error updating order status:", _context.t0);
