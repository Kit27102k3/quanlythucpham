...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import User model if notifications are for users
// Import Admin model if notifications are for admins
...
_webPush["default"].setVapidDetails('mailto:your_email@example.com',
// TODO: Replace with a valid email address
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _webPush["default"].sendNotification(subscription, JSON.stringify(payload));
        case 3:
        ...
        case 6:
          ...
          console.error('Error sending push notification for user:', userId, ':', _context.t0);

          // Handle cases where the subscription is no longer valid
          if (!(_context.t0.statusCode === 404 || _context.t0.statusCode === 410)) {
            _context.next = 22;
            break;
          }
          ...
          _context.prev = 11;
          _context.next = 14;
          return _Register["default"].findByIdAndUpdate(userId, {
            $pull: {
              pushSubscriptions: {
        ...
        case 17:
          ...
          console.error('Error removing invalid subscription from database for user:', userId, ':', _context.t1);
        case 20:
          _context.next = 23;
          break;
        case 22:
          // Handle other errors
          console.error('Failed to send push notification for user:', userId, ':', _context.t0);
        case 23:
        case "end":
