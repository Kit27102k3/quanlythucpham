...
var ReviewStatsSchema = new _mongoose["default"].Schema({
  productId: {
...
ReviewStatsSchema.statics.updateReviewStats = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(productId) {
    var Review, reviews, totalReviews, ratingSum, averageRating, verifiedReviews, ratingDistribution, stats;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          // Lấy thông tin từ model Review
          Review = _mongoose["default"].model("Review"); // Tìm tất cả đánh giá đã công khai cho sản phẩm này
          _context.next = 4;
          return Review.find({
            productId: productId,
            isPublished: true
        ...
        case 11:
          ...
          ratingSum = reviews.reduce(function (sum, review) {
            return sum + review.rating;
          }, 0);
          averageRating = ratingSum / totalReviews;
          verifiedReviews = reviews.filter(function (review) {
            return review.isVerified;
          }).length; // Tạo phân phối đánh giá
          ratingDistribution = {
            1: 0,
            2: 0,
            3: 0,
        ...
        case 25:
          ...
          console.error("Lỗi khi cập nhật thống kê đánh giá:", _context.t0);
          throw _context.t0;
        case 29:
        case "end":
...
ReviewStatsSchema.methods.getStarPercentages = function () {
  var total = this.totalReviews || 1; // Tránh chia cho 0
...
var ReviewStats = _mongoose["default"].model("ReviewStats", ReviewStatsSchema);
