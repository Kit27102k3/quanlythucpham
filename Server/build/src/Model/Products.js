...
productSchema.methods.isDiscountActive = function () {
  ...
  var now = new Date();
  return this.productDiscount > 0 && now >= this.discountStartDate && now <= this.discountEndDate;
};
productSchema.methods.toJSON = function () {
  var productObject = this.toObject();
...
productSchema.methods.updateSoldCount = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(quantity) {
