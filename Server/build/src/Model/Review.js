...
var ReplySchema = new _mongoose["default"].Schema({
  userId: {
...
ReviewSchema.statics.calculateAverageRating = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(productId) {
    var result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 7;
          return _mongoose["default"].model("Product").findByIdAndUpdate(productId, {
          ...
          setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  _context.prev = 0;
                  ReviewStats = _mongoose["default"].model("ReviewStats");
                  _context.next = 4;
                  return ReviewStats.recalculateStats(productId);
                case 4:
                  _context.next = 9;
                  break;
                case 6:
                  ...
                  console.error("Không thể cập nhật ReviewStats:", _context.t0.message);
                case 9:
                case "end":
        ...
        case 14:
          ...
          console.error("Lỗi khi cập nhật đánh giá trung bình:", _context2.t0);
        case 17:
        case "end":
...
ReviewSchema.post("findOneAndUpdate", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return _mongoose["default"].model("Review").calculateAverageRating(doc.productId);
        case 3:
        case "end":
...
ReviewSchema.pre("updateOne", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
  var docToUpdate;
...
ReviewSchema.post("updateOne", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
  return _regeneratorRuntime().wrap(function _callee5$(_context5) {
    while (1) switch (_context5.prev = _context5.next) {
      case 0:
        ...
        _context5.next = 3;
        return _mongoose["default"].model("Review").calculateAverageRating(this._productId);
      case 3:
      case "end":
