...
var getDashboardStats = exports.getDashboardStats = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _totalRevenue$, totalRevenue, totalOrders, totalProducts, totalCustomers, dailyRevenue, weeklyRevenue, monthlyRevenue, productsByCategory, finalProductsByCategory, _totalProducts, topProducts, finalTopProducts, ordersByStatus, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 24:
          productsByCategory = _context.sent;
          // Khởi tạo biến để lưu kết quả cuối cùng
          finalProductsByCategory = []; // Trong trường hợp không có dữ liệu phân loại
        ...
        case 35:
          ...
          return _Products["default"].aggregate([{
            $project: {
              ...
              soldQuantity: {
                $ifNull: ["$soldCount", 0]
              } // Sử dụng trường đếm số lượng bán nếu có
            }
          }, {
            $sort: {
              soldQuantity: -1
        ...
        case 37:
          ...
          finalTopProducts = topProducts.length > 0 ? topProducts : [{
            name: "Chưa có dữ liệu bán hàng",
            soldQuantity: 0
        ...
        case 41:
          ordersByStatus = _context.sent;
          response = {
            success: true,
            data: {
              totalRevenue: ((_totalRevenue$ = totalRevenue[0]) === null || _totalRevenue$ === void 0 ? void 0 : _totalRevenue$.total) || 0,
