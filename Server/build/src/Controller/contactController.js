...
var createContact = exports.createContact = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, name, email, message, phone, newContact, savedContact, adminsToNotify, notificationPayload, _iterator, _step, admin, _iterator2, _step2, subscription;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 11:
          adminsToNotify = _context3.sent;
          if (adminsToNotify && adminsToNotify.length > 0) {
            notificationPayload = {
              title: 'Liên hệ mới',
              body: "".concat(name, " \u0111\xE3 g\u1EEDi m\u1ED9t li\xEAn h\u1EC7 m\u1EDBi qua website."),
              data: {
                url: '/admin/contacts',
                type: 'new_contact'
              }
                ...
                try {
                  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                    ...
                    (0, _notificationService.sendPushNotification)(admin._id, subscription, notificationPayload)["catch"](function (error) {
                      return console.error('Error sending contact notification to admin:', error);
                    });
                  }
                } catch (err) {
                  _iterator2.e(err);
            ...
            console.log("\u0110\xE3 g\u1EEDi th\xF4ng b\xE1o li\xEAn h\u1EC7 m\u1EDBi \u0111\u1EBFn ".concat(adminsToNotify.length, " admins"));
          }
          _context3.next = 18;
          break;
        case 15:
          ...
          console.error('Lỗi khi gửi thông báo liên hệ mới:', _context3.t0);
