...
var updateProductExpirations = exports.updateProductExpirations = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var currentDate, discountExpiredProducts, _iterator, _step, product, expiryDateProducts, _iterator2, _step2, _product;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          currentDate = new Date(); // Cập nhật giảm giá của sản phẩm đã hết thời hạn giảm giá
          _context.next = 4;
        ...
        case 4:
          discountExpiredProducts = _context.sent;
          _iterator = _createForOfIteratorHelper(discountExpiredProducts);
          _context.prev = 6;
          _iterator.s();
        case 8:
          ...
          return product.save();
        case 16:
          console.log("\u0110\xE3 c\u1EADp nh\u1EADt gi\xE1 g\u1ED1c cho s\u1EA3n ph\u1EA9m: ".concat(product.productName));
        case 17:
          _context.next = 8;
          break;
        case 19:
        ...
        case 29:
          expiryDateProducts = _context.sent;
          _iterator2 = _createForOfIteratorHelper(expiryDateProducts);
          _context.prev = 31;
          _iterator2.s();
        case 33:
          ...
          _product.productStatus = "Hết hàng";
          _product.productStock = 0;
          _context.next = 39;
          return _product.save();
        case 39:
          console.log("\u0110\xE3 c\u1EADp nh\u1EADt tr\u1EA1ng th\xE1i \"H\u1EBFt h\xE0ng\" cho s\u1EA3n ph\u1EA9m: ".concat(_product.productName));
        case 40:
          _context.next = 33;
          break;
        case 42:
        ...
        case 53:
          ...
          console.error("Lỗi khi cập nhật hạn sản phẩm:", _context.t2);
          return _context.abrupt("return", {
    ...
    }, _callee, null, [[0, 53], [6, 21, 24, 27], [31, 44, 47, 50]]);
  }));
  return function updateProductExpirations() {
    return _ref.apply(this, arguments);
  };
}();
var createProduct = exports.createProduct = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var category, uploadedUrls, descriptions, discountStartDate, discountEndDate, expiryDate, productStatus, newProduct, savedProduct, adminsToNotify, notificationPayload, _iterator3, _step3, admin, _iterator4, _step4, subscription, productToSend;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          // Xử lý hạn sử dụng
          expiryDate = null;
          productStatus = req.body.productStatus || "Còn hàng";
        ...
        case 22:
          ...
          (0, _notificationService.sendNewProductNotification)(savedProduct)["catch"](function (error) {
            return console.error("Error sending product notification to users:", error);
          });
        ...
        case 26:
          ...
          _iterator3 = _createForOfIteratorHelper(adminsToNotify);
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              admin = _step3.value;
              _iterator4 = _createForOfIteratorHelper(admin.pushSubscriptions);
              try {
                for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                  subscription = _step4.value;
                  (0, _notificationService.sendPushNotification)(admin._id, subscription, notificationPayload)["catch"](function (error) {
                    return console.error("Error sending notification to admin:", error);
                  });
                }
              } catch (err) {
                _iterator4.e(err);
          ...
          return _context2.abrupt("return", res.status(201).json(productToSend));
        case 43:
          _context2.prev = 43;
          _context2.t0 = _context2["catch"](0);
          console.error("Error in createProduct:", _context2.t0);
          return _context2.abrupt("return", res.status(500).json({
            success: false,
            message: _context2.t0.message,
            errorDetails: process.env.NODE_ENV === "development" ? _context2.t0.stack : undefined
          }));
        case 47:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return updateProductExpirations();
        case 3:
          _context3.next = 5;
          return _Products["default"].find();
        case 5:
...
var updateProduct = exports.updateProduct = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var id, product, category, newImageUrls, existingImages, keepImages, imagesToDelete, productDescription, discountStartDate, discountEndDate, expiryDate, productStatus, updatedProduct, productToSend;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 23:
          ...
          productStatus = req.body.productStatus || product.productStatus;
          if (req.body.expiryDate) {
            expiryDate = new Date(req.body.expiryDate);
          ...
          _context5.next = 34;
          return _Products["default"].findByIdAndUpdate(id, _objectSpread(_objectSpread({}, req.body), {}, {
        ...
        case 57:
          ...
          console.error("Lỗi khi cập nhật sản phẩm:", _context5.t0);
          res.status(500).json({
            success: false,
...
var checkAndUpdateExpirations = exports.checkAndUpdateExpirations = /*#__PURE__*/function () {
  ...
  return function checkAndUpdateExpirations(_x11, _x12) {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 17:
          ...
          if (!(_context9.t0.name === "CastError" && _context9.t0.path === "_id")) {
            _context9.next = 21;
            break;
          }
          return _context9.abrupt("return", res.status(400).json({
...
var getProductByCategory = exports.getProductByCategory = /*#__PURE__*/function () {
  ...
  return function getProductByCategory(_x15, _x16) {
...
var updateProductCategory = exports.updateProductCategory = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee1$(_context1) {
      while (1) switch (_context1.prev = _context1.next) {
        ...
        case 16:
          ...
          console.error("Error in updateProductCategory:", _context1.t0);
          res.status(500).json({
  ...
  return function updateProductCategory(_x17, _x18) {
...
var getBestSellingProducts = exports.getBestSellingProducts = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var limit, period, bestSellingProducts, normalProducts, formattedProducts;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _context10.prev = 0;
          limit = parseInt(req.query.limit) || 4;
          period = req.query.period || "all"; // Tự xử lý lấy sản phẩm thường thay vì dùng Model.getBestSellers
          bestSellingProducts = [];
          _context10.prev = 4;
          _context10.next = 7;
        ...
        case 7:
          bestSellingProducts = _context10.sent;
          _context10.next = 13;
          break;
        case 10:
          _context10.prev = 10;
          _context10.t0 = _context10["catch"](4);
          console.error("[getBestSellingProducts] Lỗi khi truy vấn model BestSellingProduct:", _context10.t0);
        case 13:
        ...
        case 18:
          normalProducts = _context10.sent;
          console.log("[getBestSellingProducts] T\xECm th\u1EA5y ".concat(normalProducts.length, " s\u1EA3n ph\u1EA9m th\xF4ng th\u01B0\u1EDDng \u0111\u1EC3 thay th\u1EBF"));
        ...
        case 23:
          ...
          console.error("[getBestSellingProducts] Lỗi khi lấy sản phẩm thông thường:", _context10.t1);
          return _context10.abrupt("return", res.status(200).json({
            success: true,
        ...
        case 27:
          ...
          formattedProducts = bestSellingProducts.map(function (item) {
            // Nếu sản phẩm đã được populate đầy đủ
            if (item.productId && _typeof(item.productId) === 'object') {
              var product = _objectSpread(_objectSpread({}, item.productId.toObject()), {}, {
          ...
          console.log("[getBestSellingProducts] Tr\u1EA3 v\u1EC1 ".concat(formattedProducts.length, " s\u1EA3n ph\u1EA9m b\xE1n ch\u1EA1y \u0111\xE3 \u0111\u1ECBnh d\u1EA1ng"));
          return _context10.abrupt("return", res.status(200).json({
            success: true,
        ...
        case 32:
          ...
          console.error('[getBestSellingProducts] Lỗi:', _context10.t2.message);
          return _context10.abrupt("return", res.status(200).json({
            success: true,
    ...
    }, _callee10, null, [[0, 32], [4, 10], [15, 23]]);
  }));
  return function getBestSellingProducts(_x19, _x20) {
