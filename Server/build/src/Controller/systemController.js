...
var getSystemStats = exports.getSystemStats = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var loginCount, failedLoginCount, dataUpdateCount, errorCount, userCount, productCount, orderCount;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 5;
          _context.next = 8;
          return _SystemActivity["default"].countDocuments({
            type: 'login',
            status: 'success'
          });
        case 8:
          loginCount = _context.sent;
          _context.next = 11;
          return _SystemActivity["default"].countDocuments({
            type: 'login',
            status: 'failed'
        ...
        case 11:
          failedLoginCount = _context.sent;
          _context.next = 14;
          return _SystemActivity["default"].countDocuments({
            type: 'data_update'
          });
        case 14:
          dataUpdateCount = _context.sent;
          _context.next = 17;
          return _SystemActivity["default"].countDocuments({
            type: 'error'
          });
        case 17:
          errorCount = _context.sent;
          _context.next = 23;
          break;
        case 20:
          _context.prev = 20;
          _context.t0 = _context["catch"](5);
          console.log("Không tìm thấy bảng SystemActivity hoặc lỗi truy vấn:", _context.t0.message);
        ...
        case 35:
          ...
          console.error("Error fetching system stats:", _context.t1);
    ...
    }, _callee, null, [[0, 35], [5, 20]]);
  }));
  return function getSystemStats(_x, _x2) {
