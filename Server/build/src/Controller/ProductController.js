...
exports.getBestSellingProducts = void 0;
...
var getBestSellingProducts = exports.getBestSellingProducts = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var limit, period, bestSellers, products;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          limit = parseInt(req.query.limit) || 4;
          period = req.query.period || 'month'; // Default to monthly best sellers
          // Get best selling products
          _context.next = 5;
          return _BestSellingProduct["default"].getBestSellers(limit, period);
        case 5:
          bestSellers = _context.sent;
          // Map to ensure we have the complete product data
          products = bestSellers.map(function (item) {
            if (item.productId) {
              return {
        ...
        case 10:
          ...
          console.error("Error retrieving best selling products:", _context.t0);
  ...
  return function getBestSellingProducts(_x, _x2) {
