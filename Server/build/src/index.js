    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log("Webhook received at ".concat(path, ":"), JSON.stringify(req.body));
...
var _scheduleExpiredVoucherCleanup = function scheduleExpiredVoucherCleanup() {
  // Xóa voucher hết hạn khi khởi động server
  (0, _savedVoucherController.deleteExpiredVouchers)().then(function (result) {
  ...
  setInterval(function () {
    ...
    setTimeout(function () {
      ...
      _scheduleExpiredVoucherCleanup();
    }, timeUntilMidnight);
