...
const generateSimpleComparison = (products) => {
  ...
  if (price1 < price2 && rating1 >= rating2) {
    comparison += `${product1.productName} có vẻ là lựa chọn tốt hơn với giá thấp hơn và chất lượng tương đương hoặc tốt hơn.\n`;
  } else if (price2 < price1 && rating2 >= rating1) {
    comparison += `${product2.productName} có vẻ là lựa chọn tốt hơn với giá thấp hơn và chất lượng tương đương hoặc tốt hơn.\n`;
