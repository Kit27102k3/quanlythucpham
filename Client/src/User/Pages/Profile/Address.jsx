...
function Address() {
  ...
  return (
    <div className="mt-2">
      ...
      <button className="hover-animation-button p-2 bg-[#51bb1a] mt-2 w-[50%] uppercase text-[12px] text-white lg:w-[150px] lg:mt-4">
        Thêm địa chỉ
      </button>
      ...
      <div className="lg:grid lg:grid-cols-[70%_30%]">
        <div className="flex flex-col gap-2">
          <p className="text-[#1c1c1c] text-[12px] font-medium lg:text-sm">
            Họ tên:
            <span className="font-normal"> Nguyễn Trọng Khiêm</span>
          ...
          <p className="text-[#1c1c1c] text-[12px] font-medium lg:text-sm">
            ...
            <span className="font-normal">
              {" "}
              Nguyễn Văn Cừ nối dài, Phường An Bình, Quận Ninh Kiều, Cần Thơ,
              Vietnam
            </span>
          </p>
          <p className="text-[#1c1c1c] text-[12px] font-medium lg:text-sm">
            Số điện thoại:
            <span className="font-normal"> 0326743391</span>
          </p>
        </div>
        <button
