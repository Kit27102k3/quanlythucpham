...
function Drinks() {
  ...
  const bannerImages = [
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQu81lcEbA8tcD-oIbAEd-TNztiAXc9frcTbg&s",
      alt: "Khuyến mãi đặc biệt cho đồ uống",
    },
    {
      src: "https://cdnphoto.dantri.com.vn/yayH8Rgc3xFabGP12WSF7Li2lgc=/zoom/1200_630/2016/nuoc-1-1479783569933.jpg",
      alt: "Ưu đãi đồ uống",
    },
  ];
  ...
  useEffect(() => {
    const fetchProductCategory = async () => {
      try {
        setIsLoading(true);
        const res = await productsApi.getProductByCategory("Nước ngọt");
    ...
    <AnimatePresence mode="sync">
      ...
      >
        <SEO
          ...
          description="Đồ uống các loại chất lượng cao, đảm bảo chất lượng, giá cả hợp lý."
        />
