...
const AutoExportManager = ({ setExportLoading, onAutoExport }) => {
  ...
  const handleEdit = (config) => {
    ...
    setFormData({
      reportId: config.reportId || 'dashboard',
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-xl font-bold text-gray-800">Quản lý xuất tự động</h2>
          <p className="text-gray-600">Quản lý tất cả cấu hình xuất báo cáo tự động</p>
        </div>
        <Button 
          variant="contained" 
          color="primary" 
      ...
      {configs.length > 0 ? (
            ...
            <TableBody>
              {configs.map((config) => (
                <TableRow key={config.id}>
                  <TableCell>{formatReportName(config.reportId)}</TableCell>
        ...
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          <Typography variant="h6" color="textSecondary">
            Chưa có cấu hình xuất tự động nào
          </Typography>
          <Typography variant="body2" color="textSecondary" className="mt-2">
            Nhấn "Thêm cấu hình" để tạo cấu hình xuất tự động đầu tiên
          </Typography>
          <Button 
            variant="outlined" 
            color="primary" 
          ...
          <div className="space-y-4 pt-2">
            <FormControl fullWidth margin="dense">
              ...
              <Select
                ...
                label="Báo cáo"
              >
                <MenuItem value="dashboard">Tổng quan</MenuItem>
                <MenuItem value="revenue">Doanh thu</MenuItem>
                <MenuItem value="top-products">Sản phẩm bán chạy</MenuItem>
                <MenuItem value="inventory">Tồn kho</MenuItem>
                <MenuItem value="users">Người dùng</MenuItem>
                <MenuItem value="orders">Đơn hàng</MenuItem>
                <MenuItem value="promotions">Khuyến mãi</MenuItem>
                <MenuItem value="system-activity">Hoạt động hệ thống</MenuItem>
                <MenuItem value="delivery">Giao hàng</MenuItem>
                <MenuItem value="feedback">Phản hồi</MenuItem>
                <MenuItem value="analysis">Phân tích AI</MenuItem>
              </Select>
            </FormControl>
