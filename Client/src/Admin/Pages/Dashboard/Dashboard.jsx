      ...
      {loading ? (
        ...
        <>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xl font-semibold text-gray-800">{dashboardStats.totalOrders}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xl font-semibold text-gray-800">{dashboardStats.totalCustomers}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xl font-semibold text-gray-800">{dashboardStats.totalProducts}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xl font-semibold text-gray-800">{formatCurrency(dashboardStats.totalRevenue)}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <table className="min-w-full divide-y divide-gray-200 mb-4">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Đã bán</th>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {topProducts.map((product, index) => (
                          <tr key={index}>
                            ...
                            <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">{product.sold}</td>
                            <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">{formatCurrency(product.revenue)}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  <div className="h-60">
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <Bar dataKey="revenue" name="Doanh thu" fill="#4ade80" />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">Cảnh báo tồn kho thấp</h2>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {lowStockItems.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">{item.stock}</td>
