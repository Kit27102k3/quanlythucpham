      ...
      <td className="px-6 py-4">
        <div className="flex justify-center space-x-3">
          <Button
            ...
            className="w-10 h-10 hover:bg-blue-50 border border-transparent hover:border-blue-200 transition-all text-red-500"
            pt={{ 
          ...
          <Button
            ...
            tooltipOptions={{ position: 'top' }}
            className="w-10 h-10 hover:bg-red-50 border border-transparent hover:border-red-200 transition-all text-black"
            pt={{ 
              root: { className: 'flex items-center justify-center ' },
...
const OrderAdmin = () => {
  try {
    // Sử dụng hooks trong function component
